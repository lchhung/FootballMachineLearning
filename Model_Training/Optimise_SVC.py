...
def main():
    ...
    # while C_param_range <= 10000000000:
    while C_param_range <= 100000:
        c_param.append(C_param_range)
        C_param_range = C_param_range*10
    print(c_param)

    # while gamma_range <= 1000:
    while gamma_range <= 1000:
        gamma_param.append(gamma_range)
        gamma_range= gamma_range*10
    print(gamma_param)
