...
def main():
    ...
    models = [
        ...
        MultinomialNB(),
        SVC(kernel='rbf', C= 1.0, gamma = 0.1, random_state=42),
        KNeighborsClassifier(n_neighbors=170),
        MLPClassifier(solver='lbfgs', hidden_layer_sizes=(feat_no,), alpha=1e-5, random_state=42)

    ]
    model_names = [
        "DecisionTreeClassifier", "RandomForestClassifier", "MultinomialNB()","Suppor Vector Machine",
